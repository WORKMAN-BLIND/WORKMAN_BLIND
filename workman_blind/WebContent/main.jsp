				...
				<div class="row">
					<div class="col-lg-2 col-md-3 col-sm-6 col-6">
						<a href="#" class="mini-box"> <i><img
							...
							<strong>${sessionScope.allcompany[0].companyname}<br>인천동춘점<br></strong> <span>pc방</span>
						</a>
					</div>
					<div class="col-lg-2 col-md-3 col-sm-6 col-6">
						<a href="#" class="mini-box"> <i><img
								src="assets/images/cu.png" alt="" width="80" height="80"></i>
							<strong>${sessionScope.allcompany[1].companyname}<br>충정프랑스점</strong> <span>편의점</span>
						</a>
					</div>
					<div class="col-lg-2 col-md-3 col-sm-6 col-6">
						<a href="#" class="mini-box"> <i><img
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="team-item">
                  <div class="team-content">
                     <i><img src="assets/images/testimonial-icon.png" alt=""></i>
                     <p>Quisque diam odio, maximus ac consectetur eu, auctor non
                        lorem. Cras quis est non ante ultrices molestie. Ut vehicula et
                        diam at aliquam.</p>
                     <div class="user-image">
                        <img src="http://placehold.it/60x60" alt="">
                     </div>
