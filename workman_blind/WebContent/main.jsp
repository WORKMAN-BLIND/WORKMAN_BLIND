...
<body>
			...
			<div class="container">
				<div class="row">
					<div
						...
						<br> <br>
						<h1>
							워크맨은 오늘도 열심히 일하는<br> <strong>당신을 </strong>응원합니다.
						</h1>
						<p>개미는 뚠뚠 오늘도 뚠뚠 열심히 일을 하네..</p>
						<a href="#" class="main-button-slider" onclick="settimeoutUtube()">Discover
							More</a> <br> <br> <br> <br> <br> <br>
						<br>
					</div>

					<div id="utubeView"
						style="margin-bottom: 300px; padding-left: 272px;"></div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12"
							...
							<div class="features-small-item">
								...
								<p>더이상 선택당하지 마세요. 이제 당신이 선택할 차례입니다. 후기를 보고 꼼꼼히 고르고 골라 최고의
									알바를 선택해 지원하세요!</p>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12"
							...
							<div class="features-small-item">
								...
								<p>퇴사하셨나요? 알바 후기를 적어보세요. 잠깐의 시간을 투자해 선행을 베풀면 훗날 다시 알바를 구할때 큰
									도움을 받을지도 몰라요!</p>
							</div>
						</div>
						<!-- ***** Features Small Item End ***** -->
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="team-item">
						<div class="team-content">
							<i><img src="assets/images/testimonial-icon.png" alt=""></i>
							<p>매우 꿀알바 입니다. 알바하면서 공부 가능합니다. 근데 시급이 너무 짜요</p>
							<div class="user-image">
								<img src="http://placehold.it/60x60" alt="">
							</div>
							<div class="team-info">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="team-item">
						<div class="team-content">
							<i><img src="assets/images/testimonial-icon.png" alt=""></i>
							<p>목돈벌기 좋아요. 근데 장난감을 다루다보니 진상이 좀 많습니다. 감안하셔야되요 바짝벌고 탈주하기 좋은
								알바!</p>
							<div class="user-image">
								<img src="http://placehold.it/60x60" alt="">
							</div>
							<div class="team-info">
								<h3 class="user-name">heesung789</h3>
								<span>손오공</span>
							</div>
						</div>
					</div>
	...
	<section class="section padding-top-70 padding-bottom-0" id="features">
		...
		<div>
			<h2 class="section-title">전국 구인구직 취업동향</h2>
			<p>
				2012년 2월 ~ 2020년 11월<br> 출처 :고용노동부 <a href="#"
					class="main-button-slider" onclick="settimeoutChart()">차트 보기</a>
			</p>
		</div>
	</section>
