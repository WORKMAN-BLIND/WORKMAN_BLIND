	...
	<div id="Container">
				...
				<div class="searchBox">
					...
					<c:choose>
						...
						<!--  	<a href="plinsert.jsp">알바 구인글 작성 (기업)</a> -->
							<button type="button" onclick="location.href='plcrud/plinsert.jsp'"> 알바 구인글 작성 </button>
					</c:when>
					<c:otherwise>
					</c:otherwise>
				...
				<div class="formList">
					...
					<table summary="알바리뷰 기업목록으로 기업의 리뷰정보를 확인할 수 있습니다">
						...
						<!-- 		<th scope="col" class="repscore">
									<div class="wrap">
										<span class="icon"
											onmouseover="$(this).siblings('.markReputeHelp').show()"
											onmouseout="$(this).siblings('.markReputeHelp').hide()"></span>
										<span class="markReputeHelp" style="display: none;">작성된
											리뷰의 좋아요 수를<br> <strong>10점 만점</strong>으로 표시한 점수입니다.<span></span>
										</span>
						...
						<!--  	<tr>
								...
								<td>${list.worktime}</td>
								<td>${list.workperiod}</td> 
								<td>${list.hourlywage}</td> 
								<td> 2일 전 </td>
		...
		<td colspan="5" class="notice-tit"><a href="/story/albastory/Detail.asp?idx=2979"><strong>알바리뷰 작성 안내</strong></a></td>
						...
						<!--  	<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=171290">잇올 스파르타</a></td>
								<td class="repcnt">2</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">4.5</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216344">cu고덕그라시움점</a></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216343">두쏠뷰티헤어</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">4</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=151708">(주)에이치엔씨네트워크</a></td>
								<td class="repcnt">2</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">8.5</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=198262">컴포즈커피
										서부산유통단지점</a></td>
								<td class="repcnt">4</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">7.5</span></td>
								<td class="jobing"><a href="#"
									onclick="ReputeCLS.viewReputeJobList('%C4%C4%C6%F7%C1%EE%C4%BF%C7%C7+%BC%AD%BA%CE%BB%EA%C0%AF%C5%EB%B4%DC%C1%F6%C1%A1');return false;"><em><span
											class="icon"></span>채용중</em></a></td>
								<td class="lastregymd">24분전</td>
							</tr>
							<tr>
								<td class="cnt">208656</td>
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216342">에쓰오일본사</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=8775">월드로밍</a></td>
								<td class="repcnt">2</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216341">cu명일삼익점</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">10</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216340">세븐일레븐
										구월남동대로점</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216339">세븐일레븐둔촌2호점</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216338">유성F.T</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216337">이랜드푸드 로운
										신촌</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">7</span></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216335">롯데리아 울산남목점</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216336">GS25일산해변점</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">4</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216333">화명종합사회복지관</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">7</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216334">로뎀직업재활센터</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=151954">류니끄</a></td>
								<td class="repcnt">2</td>
								<td class="repscore"><span class="icon"></span> <span
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216332">ANDEW</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">5</span></td>
								<td class="jobing"></td>
							...
							<tr>
								...
								<td class="workcomnm"><a
									href="/story/repute/ReputeDetail.asp?idx=216331">플랜브이(주)</a></td>
								<td class="repcnt">1</td>
								<td class="repscore"><span class="icon"></span> <span
									class="text">6</span></td>
								<td class="jobing"></td>
